...
// Import pages - using the mobile versions to avoid Clerk
...
function AppContent() {
  ...
  console.log('AppWithoutClerk rendering, theme:', activeThemeValue || 'default');
...
function AppWithoutClerk() {
  console.log('=== APP WITHOUT CLERK STARTING ===');
  console.log('AppWithoutClerk component rendering - full dashboard without authentication');
