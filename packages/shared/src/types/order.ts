...
export const OrderStatusSchema = { enum: ['Draft', 'Activated', 'Processing', 'Completed', 'Shipped'] }
export const OrderStatusCodeSchema = { enum: ['Draft', 'Activated', 'Canceled', 'Expired', 'Superseded'] }
export const PaymentMethodSchema = { enum: ['Credit Card', 'Wire Transfer', 'Purchase Order'] }
...
// Order update request schema (partial version of create schema)
...
export const validateOrderCreateRequest = ajv.compile(OrderCreateRequestSchema)
export const validateOrderUpdateRequest = ajv.compile(OrderUpdateRequestSchema)
export const validateOrderQueryResponse = ajv.compile(OrderQueryResponseSchema)
