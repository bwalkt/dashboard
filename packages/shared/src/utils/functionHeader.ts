 ...
 */
export async function prepareFunctionHeader(expression: string, config: FunctionHeaderConfig = {}): Promise<FunctionHeaderResult> {
 ...
 */
export async function validateFunctionHeader(expression: string, headerValue: string): Promise<{ isValid: boolean; reason?: string }> {
