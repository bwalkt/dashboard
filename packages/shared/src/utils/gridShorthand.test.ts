...
describe('gridShorthand utilities', () => {
    ...
    describe('analyzeGridCompaction', () => {
        ...
        it('should handle the long example from the image', () => {
            const longExpr = 'timeseries.changePointDetection([hypot(linalg.qrDecomposition(grid), floor(grid[0][3])), timeseries.differencing([grid[2][3], cosh(grid[3][3]), grid[2][3]])], 5)';
