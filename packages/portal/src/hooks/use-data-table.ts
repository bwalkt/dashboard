...
interface UseDataTableProps<TData>
  extends Omit<TableOptions<TData>, 'state' | 'pageCount' | 'getCoreRowModel' | 'manualPagination'>,
...
/**
 * Create and configure a TanStack React Table instance with URL-synchronized pagination, sorting, optional column filtering, and state persistence.
 *
 * @param props - Configuration for columns, initial table state, pagination, sorting, filtering behavior, URL query synchronization, and handlers.
 * @returns An object with:
 *   - `table`: the configured React Table instance,
 *   - `shallow`: whether query state updates use shallow routing,
 *   - `debounceMs`: debounce interval (ms) applied to filter updates,
 *   - `throttleMs`: throttle interval (ms) applied to query-state synchronization.
 */
