...
/**
 * Renders a styled DayPicker calendar with custom navigation icons and merged class names.
 *
 * @param className - Additional classes merged into the calendar container.
 * @param classNames - Class name mappings merged with the component's default DayPicker styles.
 * @param showOutsideDays - Whether to display days from adjacent months; defaults to `true`.
 * @returns A DayPicker React element configured with the component's default styles and navigation icons.
 */
