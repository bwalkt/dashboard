...
export function DataTableSheetRowAction<TData, TFields extends DataTableFilterField<TData>>({
        ...
        return (
          <DropdownMenuItem
            onClick={() => {
              ...
              const newValue = filterValue?.includes(value) ? filterValue : [...(filterValue || []), value]
  ...
  return (
    <DropdownMenu>
      ...
      >
        {children}
        {isCopied ? <div className="absolute inset-0 bg-background/70 place-content-center">Value copied</div> : null}
      </DropdownMenuTrigger>
