...
export function DataTableGroupBy<TData>({ groupByOptions, groupBy, onGroupByChange }: DataTableGroupByProps<TData>) {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-[200px]">
        {groupByOptions.map(option => (
          <DropdownMenuItem key={String(option.value)} onSelect={() => onGroupByChange(option.value)}>
