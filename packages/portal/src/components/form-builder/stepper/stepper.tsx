    ...
    >
      <div
        ...
        className={cn(
          ...
          'flex items-center',
          variant === 'line' && 'border-s-[3px] py-2 ps-3 data-[active=true]:border-gray-12',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === 'line' && 'flex-1 flex-col border-gray-4 border-t-[3px] data-[active=true]:border-gray-12',
...
>((props, ref) => {
  ...
  return (
    <Flex ref={ref} className={cn(iconVariants({ size }), props.className)} align="center" justify="center" {...rest} />
  )
})
...
const StepIcon = React.forwardRef<HTMLDivElement, StepIconProps>((props, ref) => {
  ...
  if (isCurrentStep) {
    ...
    if (isLoading) {
      return <Loader className={cn(iconVariants({ size }), 'animate-spin')} />
    }
  }
  if (Icon) {
    return (
...
const Stepper = React.forwardRef<HTMLDivElement, StepperProps>(
  (
    { size = 'md', orientation = 'horizontal', responsive = true, initialStep = 0, ...props },
    ...
    return (
      ...
      >
        ...
        {orientationValue === 'horizontal' && <HorizontalContent>{items}</HorizontalContent>}
        {footer}
      </StepperProvider>
    )
  },
