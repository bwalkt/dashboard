...
import { getTimingColor, getTimingLabel, getTimingPercentage, timingPhases } from '@/lib/request/timing'
...
export const columns: ColumnDef<ColumnSchema>[] = [
  {
    ...
    maxSize: 27,
    meta: {
      headerClassName: 'w-[--header-level-size] max-w-[--header-level-size] min-w-[--header-level-size]',
  ...
  },
  {
    ...
    meta: {
      label: 'Request Id',
      cellClassName: 'font-mono w-[--col-uuid-size] max-w-[--col-uuid-size] min-w-[--col-uuid-size]',
      headerClassName: 'min-w-[--header-uuid-size] w-[--header-uuid-size] max-w-[--header-uuid-size]',
    },
  },
  {
    accessorKey: 'status',
  ...
  },
  {
    ...
    meta: {
      ...
      headerClassName: 'w-[--header-method-size] max-w-[--header-method-size] min-w-[--header-method-size]',
    },
  },
  {
    accessorKey: 'host',
  ...
  },
  {
    ...
    minSize: 110,
    meta: {
      headerClassName: 'w-[--header-latency-size] max-w-[--header-latency-size] min-w-[--header-latency-size]',
      cellClassName: 'font-mono w-[--col-latency-size] max-w-[--col-latency-size] min-w-[--col-latency-size]',
    },
  },
  {
    accessorKey: 'regions',
    ...
    minSize: 163,
    meta: {
      headerClassName: 'w-[--header-regions-size] max-w-[--header-regions-size] min-w-[--header-regions-size]',
      cellClassName: 'font-mono w-[--col-regions-size] max-w-[--col-regions-size] min-w-[--col-regions-size]',
    },
  },
  {
    accessorKey: 'timing',
  ...
  },
  {
    ...
    meta: {
      label: 'TLS',
      headerClassName: 'w-[--header-timing-tls-size] max-w-[--header-timing-tls-size] min-w-[--header-timing-tls-size]',
      cellClassName: 'font-mono w-[--col-timing-tls-size] max-w-[--col-timing-tls-size] min-w-[--col-timing-tls-size]',
    },
  },
  {
    id: 'timing.ttfb',
