...
/**
 * Renders a full-width button that initiates GitHub authentication using either the web or Tauri flow.
 *
 * The button selects the appropriate sign-in flow based on the runtime environment, disables itself while that flow is loading, and displays toast notifications for success and error outcomes.
 *
