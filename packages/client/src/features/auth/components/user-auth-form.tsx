...
export default function UserAuthForm() {
  ...
  return (
    <>
      <Form form={form} onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-2">
        <FormInput control={form.control} name="email" label="Email" placeholder="Enter your email..." disabled={loading} />
