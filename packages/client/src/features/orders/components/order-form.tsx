...
import { Order, OrderCreateRequest, OrderCreateRequestSchema, OrderUpdateRequest } from "@dashboard/shared-types";
      ...
      <CardContent>
        <Form form={form} onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <FormInput control={form.control} name="AccountId" label="Account ID" placeholder="Enter Salesforce Account ID (e.g., 001000000000000)" required />
            ...
            <FormInput control={form.control} name="Customer_Name__c" label="Customer Name" placeholder="Enter customer name" />

            <FormInput control={form.control} name="Customer_Email__c" label="Customer Email" placeholder="Enter customer email" type="email" />
            ...
            <FormDatePicker control={form.control} name="EffectiveDate" label="Effective Date" config={{ placeholder: "Select effective date" }} />

            <FormInput control={form.control} name="Quantity__c" label="Quantity" placeholder="Enter quantity" type="number" min={0} />
            ...
            <FormInput control={form.control} name="Total_Amount__c" label="Total Amount" placeholder="Enter total amount" type="number" min={0} step="0.01" />
          </div>
          ...
          <Button type="submit">{isSubmitting || isUpdating ? "Saving..." : initialData ? "Update Order" : "Create Order"}</Button>
        </Form>
      </CardContent>
    </Card>
  );
