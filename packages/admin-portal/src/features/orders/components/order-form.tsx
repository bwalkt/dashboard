...
import { type Order, type OrderCreateRequest, OrderCreateRequestSchema, type OrderUpdateRequest } from '@pzero/shared'
...
/**
 * Renders a form for creating or editing an Order record.
 *
 * The form initializes with sensible defaults or values from `initialData`, validates input
 * against the OrderCreateRequestSchema, and submits create or update requests to the API.
 * On successful create or update the component navigates to `/dashboard/orders`, shows a success toast,
 * and invalidates the `orders` query cache.
 *
 * @param initialData - Optional existing order to edit; when provided the form updates that order.
 * @param pageTitle - Title displayed in the form header.
 * @returns The rendered Order form component.
 */
