...
import { type Product, type ProductCreateRequest, ProductCreateRequestSchema } from '@pzero/shared'
...
/**
 * Render a form for creating or editing a Product2 record.
 *
 * @param initialData - Existing product to prefill the form; `null` indicates creating a new product.
 * @param pageTitle - Title displayed in the form header.
 * @returns The product form UI as a React element.
 */
        ...
        <Form form={form} onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <FormInput
              ...
              placeholder="Enter custom external ID"
            />
          </div>
          ...
          <FormCheckbox
            ...
            description="Check this box to make the product active"
          />
